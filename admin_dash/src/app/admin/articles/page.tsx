          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-outline-variant">
              {loading ? (
                ...
                <tr><td colSpan={5} className="px-stack-md py-12 text-center text-secondary">No articles found. <Link href="/admin/articles/edit" className="text-primary hover:underline">Create one.</Link></td></tr>
              ) : (
